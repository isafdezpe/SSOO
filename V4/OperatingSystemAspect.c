...
# 999 "OperatingSystemAspect.c"
{
# 1001 "OperatingSystemAspect.c"
__uint64_t retValue_acc;
...
PID = OperatingSystem_CreateProcess(i, DAEMONSQUEUE); }else{
...
ComputerSystem_DebugMessage(110, 'p', PID, (programList[processTable[PID].programListIndex]->executableName), statesNames[previousState], statesNames[1]); } }
...
ComputerSystem_DebugMessage(110, 'p', PID, (programList[processTable[PID].programListIndex]->executableName), statesNames[previousState], statesNames[3]); } }
...
ComputerSystem_DebugMessage(110, 'p', PID, (programList[processTable[PID].programListIndex]->executableName), statesNames[previousState], statesNames[2]); 
...
ComputerSystem_DebugMessage(110, 'p', executingProcessID, (programList[processTable[executingProcessID].programListIndex]->executableName), statesNames[previousState], statesNames[4]); 
#line 436 "OperatingSystem.c"
if ((programList[processTable[executingProcessID].programListIndex]->type) == USERPROGRAM){
numberOfNotTerminatedUserProcesses--; }
#line 440 "OperatingSystem.c"
if (numberOfNotTerminatedUserProcesses == 0 && OperatingSystem_IsThereANewProgram() == (-1) && numberOfSleepingProcesses <= 0){
{ 
...
ComputerSystem_DebugMessage(115, 's', executingProcessID, (programList[processTable[executingProcessID].programListIndex]->executableName), PID, (programList[processTable[PID].programListIndex]->executableName)); 
...
case SYSCALL_SLEEP: processTable[executingProcessID].whenToWakeUp = abs(Processor_GetAccumulator()) + numberOfClockInterrupts + 1; 
...
ComputerSystem_DebugMessage(114, 's'); }else{
{ 
...
ComputerSystem_DebugMessage(107, 's', readyToRunQueue[USERPROCESSQUEUE][i], processTable[readyToRunQueue[USERPROCESSQUEUE][i].info].priority, "\n"); }else{
ComputerSystem_DebugMessage(107, 's', readyToRunQueue[USERPROCESSQUEUE][i], processTable[readyToRunQueue[USERPROCESSQUEUE][i].info].priority, ","); }} } } }
...
ComputerSystem_DebugMessage(107, 's', readyToRunQueue[DAEMONSQUEUE][i], processTable[readyToRunQueue[DAEMONSQUEUE][i].info].priority, "\n"); }else{
ComputerSystem_DebugMessage(107, 's', readyToRunQueue[DAEMONSQUEUE][i], processTable[readyToRunQueue[DAEMONSQUEUE][i].info].priority, ","); }} } } }
...
ComputerSystem_DebugMessage(121, 's', executingProcessID, (programList[processTable[executingProcessID].programListIndex]->executableName), PIDWithMaxPriority, (programList[processTable[PIDWithMaxPriority].programListIndex]->executableName)); 
