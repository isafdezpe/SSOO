...
ComputerSystem_DebugMessage(115, 's', oldPID, (programList[processTable[oldPID].programListIndex]->executableName), PID, (programList[processTable[PID].programListIndex]->executableName)); 
